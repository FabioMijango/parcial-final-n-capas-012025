...
public class TicketController {
    ...
    public ResponseEntity<GeneralResponse> getTicketById(@PathVariable Long id) {
        ...
        if (isUser && !ticket.getCorreoSolicitante().equals(auth.getName())) {
    ...
    @PostMapping
    public ResponseEntity<GeneralResponse> createTicket(@Valid @RequestBody TicketCreateRequest ticket, Authentication authentication) {
        ticket.setCorreoUsuario(authentication.getName()); // Setea el correo del usuario logueado
